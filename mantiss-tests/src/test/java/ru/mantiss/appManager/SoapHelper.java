...
public class SoapHelper {
    ...
    private MantisConnectPortType getMantisConnect() throws ServiceException, MalformedURLException {
        return new MantisConnectLocator().getMantisConnectPort(
                new URL(app.getProperty("mantisConnect.url")));
    }
    ...
    public Issue addIssue(Issue issue) throws MalformedURLException, ServiceException, RemoteException {
        ...
        issueData.setCategory(mc
                .mc_project_get_categories("administrator", "root", issueData.getProject().getId())[0]);
    ...
    public String getIssueResolutionById(int issueId) throws MalformedURLException, ServiceException, RemoteException {
        MantisConnectPortType mc = getMantisConnect();
        return mc.mc_issue_get("administrator", "root", BigInteger.valueOf(issueId)).getResolution().getName();
    }
}
